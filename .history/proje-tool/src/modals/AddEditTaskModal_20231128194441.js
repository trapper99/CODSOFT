        ...
        shadow-md shadow-[#364e7e1a] max-w-md mx-auto w-full px-8 py-8 rounded-xl'>
            ...
            <div className='mt-8 flex flex-col space-y-3'>
                ...
                <select
                 ...
                 className='select-status flex-grow px-4 py-2 rounded-md text-sm bg-transparent focus:border-0 border-[1px] border-gray-300 focus:outline-[#635fc7] outline-[1px]'></select>
            </div>
        </div>
    </div>
  )
