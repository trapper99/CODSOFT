    ...
    >
        ...
        shadow-md shadow-[#364e7e1a] max-w-md mx-auto w-full px-8 py-8 rounded-xl'>
            ...
            <div className='mt-8 flex flex-col space-y-3'>
                ...
                <button className='w-full items-center dark:text-[#635fc7] dark:bg-white text-white bg-[#635fc7] py-2 rounded-full' onClick={onAddSubtask} onKeyDown={onAddSubtask'></button>
            </div>
        </div>
    </div>
  )
