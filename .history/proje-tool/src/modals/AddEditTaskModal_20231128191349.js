        ...
        shadow-md shadow-[#364e7e1a] max-w-md mx-auto w-full px-8 py-8 rounded-xl'>
            ...
            <div className='mt-8 flex flex-col space-y-1'>
                ...
                <textarea
                  ...
                  type='text'
                  className='bg-transparent px-4 py-2 outline-none min-h-[200p] focus:border-0 rounded-md text-sm border-[0.5px] border-gray-600 focus:outline-[#635fc7] outline-[1px]'
                  placeholder='e.g Take Coffee break'
                />
            </div>
        </div>
