...
function AddEditBoardModal({setIsBoardModalOpen, type}) {
    ...
    const setIsValid = React.useMemo(() => true, []);
            ...
            <div className='mt-8 flex flex-col space-y-3'>
                ...
                <div>
                    ...
                    <button
                      ...
                      className='w-full items-center hover:opacity-70 dark:text-white dark:bg-[#635fc7] mt-8 relative text-white bg-[#635fc7] py-2 px-4 bottom-4 rounded-full'>
