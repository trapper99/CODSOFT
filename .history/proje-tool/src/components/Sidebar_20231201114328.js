                    ...
                    <div className='bg-white dark:bg-[#2b2c37] w-full py-4 rounded-xl'>
                        ...
                        <div className='dropdown-board flex flex-col h-[70vh] justify-between'>
                            <div>
                                {boards.map((board) => (
                                    <div
                                     className={'flex items-baseline space-x-2 px-5 mr-8 rounded-r-full duration-500 ease-in-out py-4 cursor-pointer hover:bg-[#635fc71a] hover:text-[#635fc7] dark:hover'}></div>
                                ))}
                            </div>
                        </div>
                    </div>
