  ...
  return (
    <div className='bg-white dark:bg-[#2b2c47] h-screen w-screen flex flex-col items-center justify-center'>
        ...
        <button
          ...
          className='w-full items-center max-w-xs font-bold hover:opacity-70 dark:text-white dark:bg-[#635fc7] mt-8 relative text-white bg-[#635fc7] py-2 rounded-full'></button>
    </div>
  )
}
