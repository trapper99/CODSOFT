                            ...
                            <div>
                                {boards.map((board) => (
                                    <div
                                     ...
                                     onKeyDown={() => {
                                        ...
                                        <img src={boardIcon} className='w-4 h-4 filter-white dark:filter-invert' alt/>{" "}
                                ...
                                <div
                                  ...
                                  onKeyDown={() => setIsBoardModalOpen(true)}>
                                    <img src={boardIcon} className='w-4 h-4 filter-white dark:filter-invert' alt='board icon'/>
